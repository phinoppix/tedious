...
declare type BeginTransactionCallback = 
/**
...
declare type SaveTransactionCallback = 
/**
...
declare type CommitTransactionCallback = 
/**
 ...
 */
(err: Error | null | undefined) => void;
declare type RollbackTransactionCallback = 
/**
 ...
 */
(err: Error | null | undefined) => void;
declare type TransactionDoneCallback = (err: Error | null | undefined, ...args: any[]) => void;
declare type CallbackParameters<T extends (err: Error | null | undefined, ...args: any[]) => any> = T extends (err: Error | null | undefined, ...args: infer P) => any ? P : never;
...
declare type Authentication = DefaultAuthentication | NtlmAuthentication | AzureActiveDirectoryPasswordAuthentication | AzureActiveDirectoryMsiAppServiceAuthentication | AzureActiveDirectoryMsiVmAuthentication | AzureActiveDirectoryAccessTokenAuthentication | AzureActiveDirectoryServicePrincipalSecret;
